...
class Terrain2Object : EditorWindow
{
   ...
   [MenuItem("AutoDRIVE/Terrain Tools/Export Terrain to Object")]
   static void Init()
   {
      terrain = null;
      ...
      EditorWindow.GetWindow<Terrain2Object>().Show();
   }
   ...
   void OnGUI()
   {
      if (!terrain)
      {
         ...
         {
            EditorWindow.GetWindow<Terrain2Object>().Close();
         }
         return;
      }
