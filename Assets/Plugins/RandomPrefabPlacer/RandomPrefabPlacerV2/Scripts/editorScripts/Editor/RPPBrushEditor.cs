       ...
       // public RandomPrefabPlacer placer = null;
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (selectedItem != -1)
            {
                ...
                {
                    brushImg = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/RandomPrefabPlacer/RandomPrefabPlacerV2/scripts/editorScripts/Images/kw_icon_brush.png", typeof(Texture2D));
                }
                            
                //brushImg = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/RandomPrefabPlacer/RandomPrefabPlacer/scripts/editorScripts/Images/kw_icon_brush.png", typeof(Texture));
        ...
        private void DrawElement(Rect rect, int index, bool active, bool focused)
        {
            ...
            if(brushImg == null)
            {
                brushImg = (Texture2D)AssetDatabase.LoadAssetAtPath("Assets/Plugins/RandomPrefabPlacer/RandomPrefabPlacerV2/scripts/editorScripts/Images/kw_icon_brush.png", typeof(Texture));
            }
